...
MEDIA_BUCKET = os.getenv("MEDIA_BUCKET", "dms-platform-media-891377130720")

def get_s3_client():
    """Retorna cliente de S3 configurado (usa el rol IAM de la instancia)"""
...
def procesar_archivo_stock(archivo, usuario):
    ...
    try:
        ...
        try:
            ...
            # Usar id de carga para evitar colisiones
            ...
            print(f"⚠️ Error subiendo a S3 (continuando con carga): {e}")
            archivo.seek(0)
