...
if not DEBUG:
    ...
    SESSION_COOKIE_SECURE = os.getenv('SECURE_SSL_REDIRECT', 'True') == 'True'  # Cookies solo por HTTPS
    CSRF_COOKIE_SECURE = os.getenv('SECURE_SSL_REDIRECT', 'True') == 'True'  # CSRF cookies solo por HTTPS
